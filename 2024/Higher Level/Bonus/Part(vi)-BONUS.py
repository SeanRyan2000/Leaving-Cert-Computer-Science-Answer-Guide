...
random_fruits = [choice(fruits) for _ in range(10)]  # Example with 10 fruits.
# This is an example of us creating 10 random fruits

# Initialize a set called seen 
seen = set()
for fruit in random_fruits:
    # Check if fruit is in seen
    if fruit in seen:
        print("Matching pair:", fruit)
    else:
        # If fruit not in seen. Add it
        seen.add(fruit)